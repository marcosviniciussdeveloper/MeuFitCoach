...
namespace MeuFitCoach.Infrastructure.Migrations
{
    ...
    [Migration("20251016160919_AdicionaSessaoConversa")]
    partial class AdicionaSessaoConversa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeuFitCoach.Domain.Enum.SessaoConversa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("Equipmentos")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MeuFitCoach.Domain.Usuarios.Usuario", b =>
                {
                    ...
                    b.Property<string>("TempoDeTreino")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MeuFitCoach.Domain.Enum.SessaoConversa", b =>
                {
                    b.HasOne("MeuFitCoach.Domain.Usuarios.Usuario", "Usuario")
                        .WithOne("Sessao")
                        .HasForeignKey("MeuFitCoach.Domain.Enum.SessaoConversa", "UsuarioId")
