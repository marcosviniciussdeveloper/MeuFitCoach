...
namespace MeuFitCoach.Infrastructure.Migrations
{
    ...
    [Migration("20251018175412_AtualizarBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeuFitCoach.Domain.Usuarios.SessaoConversa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MeuFitCoach.Domain.Usuarios.SessaoConversa", b =>
                {
                    b.HasOne("MeuFitCoach.Domain.Usuarios.Usuario", "Usuario")
                        .WithOne("Sessao")
                        .HasForeignKey("MeuFitCoach.Domain.Usuarios.SessaoConversa", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
