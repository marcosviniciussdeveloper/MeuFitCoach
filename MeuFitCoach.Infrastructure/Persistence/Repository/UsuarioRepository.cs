...
public class UsuarioRepository: IUsuarioRepository
{
    ...
    public async Task<Usuario> GetByIdNumeroWhatsappAsync(string numeroWhatsapp)
    {
         return await _context.Usuario
            .FirstOrDefaultAsync(u => u.NumeroTelefone == numeroWhatsapp) 
            ?? throw new KeyNotFoundException($"Usuario with NumeroWhatsapp {numeroWhatsapp} not found.");
    }
    ...
    public async Task<Usuario> ObterPorNumeroComSessaoAsync(string numeroWhatsapp)
    {
        return await _context.Usuario
             .Include(u => u.Sessao)
             .FirstOrDefaultAsync(u => u.NumeroTelefone == numeroWhatsapp);
